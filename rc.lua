...
themes_dir = (config_dir .. "/themes/default/")
...
vicious.register(tdwidget, vicious.widgets.date, '<span font="Liberation 10" color="#AAAAAA" background="#1F2428"> %b %d %I:%M </span>', 20)
...
vicious.register(netwidget, vicious.widgets.net, function(widgets,args)
    ...
    return '<span font="Liberation 10" color="#AAAAAA" background="#313131">' ..args["{"..interface.." down_kb}"]..'kbps'..'</span>' end, 10)
...
vicious.register(memwidget, vicious.widgets.mem, '<span background="#1F2428" font="Liberation 10"> <span font="Liberation 10" color="#AAAAAA" background="#1F2428">$2MB </span></span>', 20)
...
'<span background="#313131" font="Liberation 10"> <span font="Liberation 10" color="#AAAAAA">$2%<span color="#888888">·</span>$3% </span></span>', 10)
...
'<span background="#313131" font="Liberation 10"> <span font="Liberation 10" color="#AAAAAA">${/home used_p}/${/home avail_p} GB </span></span>', 800)
...
clientkeys = awful.util.table.join(
    ...
    -- Moving focus to specific monitor
